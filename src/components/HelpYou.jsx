    ...
    return(
        <div className="font-poppins md:mt-20 md:mb-20 mb-12">
            <div className="flex items-center justify-center">
                <h1 className="md:text-3xl text-[22px] mt-2 font-semibold">See How Flatwala.In Can Help You</h1>
            </div>
            ...
            <div className="flex md:flex-row flex-col justify-center items-center">
                ...
                <div className=" p-4 flex md:mt-8"> 
                    <div className="rounded-xl w-96 flex flex-col justify-center items-center px-6 md:py-4">
                        ...
                        <button className="border-black border-2   py-4 px-8 rounded-2xl text-lg  flex">Find a Rental 
                        <img src={arrow} alt="arrow" className=" ml-2 mt-2" />
                        </button>
                    </div>
                </div>
